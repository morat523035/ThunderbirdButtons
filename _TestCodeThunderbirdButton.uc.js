    ...
    try {
     ...
     // var ps = Components.classes["@mozilla.org/embedcomp/prompt-service;1"]. // Thunderbird 102
      ...
      if (location == "chrome://messenger/content/messenger.xul" ||
        ...
        menuitem.setAttribute("oncommand", "window.moveTo(-7, 0); window.resizeTo(1611, 1167);");
        menupopup.appendChild(menuitem);
        var menuitem = document.createXULElement("menuitem");
        menuitem.setAttribute("class", "menuitem-iconic");
        menuitem.setAttribute("label", "Test for window.outerWidth plus 8 bug");
      ...
      var props = {
        id: "__unique_identifier_test_code_button",
