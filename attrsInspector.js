...
// Ctrl+Shift+C copying from tooltip workaround
// https://forum.mozilla-russia.org/viewtopic.php?pid=803557#p803557
...
*/
			...
			data["text/" + (this.fxVersion >= 111 ? "plain" : "unicode")] = text.replace(/\r\n?|\n/g, this.lineBreak);
